    ...
    try {
      await emailjs.send(
        ...
        "template_2j052ei",
        {
          ...
          to_email: "sahithi.veeravalli19@gmail.com",
        }
      );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.form
            ...
            <motion.button
              type="submit"
              disabled={isSubmitting}
              className={`w-full px-8 py-5 rounded-xl font-semibold text-lg flex items-center justify-center gap-3 transition-all ${
              ...
              whileHover={!isSubmitting ? { scale: 1.02, boxShadow: "0 0 40px -5px hsl(82 85% 55% / 0.5)" } : {}}
